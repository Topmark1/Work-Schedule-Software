...
function Day({worker,m,a,e,n}){
  ...
  return (
    <>
      <td className="border px-4 pb-[1px] "><span><span className="text-[10px]">{getInitials(worker)}</span><span className="flex">{m}{a}{e}{n}</span></span></td>
    </>
  )
}
